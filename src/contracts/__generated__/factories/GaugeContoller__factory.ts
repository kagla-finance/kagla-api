...
export class GaugeContoller__factory {
  static readonly abi = _abi;
  static createInterface(): GaugeContollerInterface {
    return new utils.Interface(_abi) as GaugeContollerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): GaugeContoller {
    return new Contract(address, _abi, signerOrProvider) as GaugeContoller;
  }
}
